    ...
    <div class="home">
        ...
        <div class="home-footer">
            <el-card class="box-card">
                ...
                <div v-for="(New,index) in news" :key="index" class="text item">
                    {{  New.name }}
                </div>
            </el-card>
        </div>
...
<script>
    export default {
        data() {
            return {
                totalData: [],
                news:[{id:'1',name:'总销售额突破历史新高'},{id:'2',name:'贯彻勇攀高峰理念'},{id:'3',name:'销售量达到本月目标值'}]
            };
        },
        mounted() {
